export {
  ...
  const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlodW9zaHp5bm9tZXpsanR5Ynh2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDI1ODExNTgsImV4cCI6MjAxODE1NzE1OH0.6rbdtoapW3Uo6KDLc1UD6kmVHOMlgU63zc1AEyjq-dI';
  
  const urlBase = 'https://yhuoshzynomezljtybxv.supabase.co';
  const headers = {
    apiKey: SUPABASE_KEY,
